## Code that tells the shiny app to input your 15N and 13C values, returns output based on your 15N and 13C values.
## If range of values do not fall within a specific group, then "Diverse diet, your isotope values reflect a mixing of multiple sources"
